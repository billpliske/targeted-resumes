        ...
        {!loaded ? (
          ...
          <>
            ...
            <div className="settings-field">
              ...
              <p className="settings-hint">
                Public GitHub repos to check for real, verifiable skills/tools when tailoring — a portfolio
                site, a side project, etc. After adding or removing one here, click Save above, then ask
                Claude Code to sync your personal projects; it reads the actual code, it doesn't guess.
              </p>
            </div>
          </>
        )}
